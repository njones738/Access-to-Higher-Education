...
kay <- CollegeSC18 %>% mutate("GRADUATED" = OMAWDP8_ALL,
                              "TRANSFERRED" = OMENRAP_ALL,
                              "NOT_GRAD_NOT_TRAN" = OMENRYP_ALL + OMENRUP_ALL)
kay %>% select(GRADUATED,TRANSFERRED,NOT_GRAD_NOT_TRAN) %>% summary()
```
