...
CollegeSC18 <- read.csv("D:/CURRENT/DATA_PROJECTS/CollegeScorecard/SSS_presentation/COMPLETED/MERGED2018_19_PP.csv", stringsAsFactors = TRUE, na.strings = c("PrivacySuppressed","NULL","NaN","NA"))
CollegeSC18 <- tibble(CollegeSC18)
#CollegeSC18[2380:2389] %>% select(Top_100) %>% head(10)

RANK_DATA <- read.csv("D:/CURRENT/DATA_PROJECTS/CollegeScorecard/SSS_presentation/COMPLETED/RANKING_DATA.csv", stringsAsFactors = TRUE, na.strings = c("PrivacySuppressed","NULL","NaN","NA"))
...
```{r SLIDE 13: PELL vs DROP}
###############################################################################
### SLIDE 13: Pell Grant vs dropout
###############################################################################
...
```{r SLIDE 15: GRAD vs DEFAULT}
###############################################################################
### SLIDE 15: Graduation vs 2-year default rate
###############################################################################
...
CSC18_REG %>% ggplot(aes(DEP_DEBT_N,DEP_DEBT_MDN)) + geom_point() + 
